...
class ImageUpload extends CAction
{
	...
	public function run($attr)
	{
		...
		if ($this->uploadUrl===null) {
			$this->uploadUrl=Yii::app()->request->baseUrl .'/images/upload/';
			// $this->uploadUrl=realpath(Yii::app()->basePath.'/../images/upload/').'/';
		}
		...
		if ($file instanceof CUploadedFile) {
			...
			$attributePath=$this->uploadPath.DIRECTORY_SEPARATOR.DIRECTORY_SEPARATOR.$attribute;
			...
			$attributeUrl=$this->uploadUrl.'/'.$fileName;
			$data = array(
